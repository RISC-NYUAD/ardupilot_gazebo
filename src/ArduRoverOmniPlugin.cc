...
#include "include/ArduRoverOmniPlugin.hh"

#define MAX_MOTORS 255

using namespace gazebo;

GZ_REGISTER_MODEL_PLUGIN(ArduRoverOmniPlugin)
...
// Private data class
class gazebo::ArduRoverOmniSocketPrivate
{
  /// \brief constructor
  public: ArduRoverOmniSocketPrivate()
  {
...
// Private data class
class gazebo::ArduRoverOmniPluginPrivate
{
  ...
  public: ArduRoverOmniSocketPrivate socket_in;

  /// \brief Ardupilot Socket to send state to Ardupilot
  public: ArduRoverOmniSocketPrivate socket_out;
...
/////////////////////////////////////////////////
ArduRoverOmniPlugin::ArduRoverOmniPlugin()
  : dataPtr(new ArduRoverOmniPluginPrivate)
{
...
/////////////////////////////////////////////////
void ArduRoverOmniPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  GZ_ASSERT(_model, "ArduRoverOmniPlugin _model pointer is null");
  GZ_ASSERT(_sdf, "ArduRoverOmniPlugin _sdf pointer is null");
...
*/
  ...
  if (!InitArduRoverOmniSockets(_sdf))
  {
    return;
  }
  ...
  this->dataPtr->updateConnection = event::Events::ConnectWorldUpdateBegin(
      std::bind(&ArduRoverOmniPlugin::OnUpdate, this));
...
/////////////////////////////////////////////////
void ArduRoverOmniPlugin::OnUpdate()
{
...
/////////////////////////////////////////////////
void ArduRoverOmniPlugin::ResetPIDs()
{
...
/////////////////////////////////////////////////
bool ArduRoverOmniPlugin::InitArduRoverOmniSockets(sdf::ElementPtr _sdf) const
{
...
/////////////////////////////////////////////////
void ArduRoverOmniPlugin::ApplyMotorForces(const double _dt)
{
...
/////////////////////////////////////////////////
void ArduRoverOmniPlugin::ReceiveMotorCommand()
{
...
/////////////////////////////////////////////////
void ArduRoverOmniPlugin::SendState() const
{
  // send_fdm
  fdmPacket pkt;
