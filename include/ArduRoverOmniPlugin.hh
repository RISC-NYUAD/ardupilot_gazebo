 ...
 *
*/
#ifndef GAZEBO_PLUGINS_ARDUROVEROMNIPLUGIN_HH_
#define GAZEBO_PLUGINS_ARDUROVEROMNIPLUGIN_HH_
...
namespace gazebo
{
  ...
  class ArduRoverOmniSocketPrivate;
  class ArduRoverOmniPluginPrivate;
  ...
  class GAZEBO_VISIBLE ArduRoverOmniPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: ArduRoverOmniPlugin();
    ...
    private: bool InitArduRoverOmniSockets(sdf::ElementPtr _sdf) const;

    /// \brief Private data pointer.
    private: std::unique_ptr<ArduRoverOmniPluginPrivate> dataPtr;
